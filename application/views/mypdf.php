    ...
    <style>
		...
		* {
		...
		main {
		  ...
		  height: 100vh;
		  z-index: -10;
		  background: -webkit-gradient(linear, left bottom, left top, from(#1b1d1d), to(rgba(255, 255, 255, 0.75)));
		...
		.crane__list .crane-stand {
		  ...
		  right: 25%;
		  z-index: 1;
		  background: -webkit-gradient(linear, left bottom, left top, from(#4bafac), to(#bfd4d3));
...
<body>
    <div class="container">
			<main>
			  <section class="advice">
			    <h1 class="advice__title">Kendala menghubungi server DB!</h1>
			    <p class="advice__description"><span>Periksa konfigurasi <</span> database <span>/></span></p>
			  </section>
    ...
    <script type="text/javascript">
      setTimeout(function(){
        window.location.replace('<?php echo base_url();?>oper');
      },10000);
    </script>
    </body>
</html>

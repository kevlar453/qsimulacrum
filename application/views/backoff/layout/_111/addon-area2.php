<script>
    ...
    function hapusjurnal(id){
      ...
      swal({
        title: "Benar hapus data?",
        text: "Belum ada fitur undo lho!",
        type: "warning",
        ...
        setTimeout(function(){
          $.ajax({
              ...
              success: function(data){
                swal({
                  title:"Terhapus!",
                  text:"Proses penghapusan berhasil.",
                  type:"success",
                  timer: 1000,
              ...
              {
                  swal("Maaf!", "Penghapusan data gagal.", "warning");
              }
          })
        }, 2000);
      });

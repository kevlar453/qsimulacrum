...
//            "dom": 'Bfrtip',
            ...
            {
                "extend": 'print',
                "message": 'Laporan Pendapatan Dokter',
            ...
            },
            {
                extend: 'excel',
                footer: true,
                title: 'Data Pendapatan Dokter',
                text: '<i class="fa fa-file-excel-o"></i>',
                titleAttr: 'Export: EXCEL',
                filename: 'PDokter_' + t1 + '_' + t2,
                sheetName: ktx + t1 + '_' + t2,
            ...
            },
            {
                ...
                "customize": function ( doc ) {
                  ...
                  doc.content[1].table.widths = ['5%','15%','15%','25%','25%','15%'];

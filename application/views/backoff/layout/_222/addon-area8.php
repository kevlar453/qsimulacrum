...
function fillgrid(){
  ...
  var f2 = toDate($('#fl_tgl2').val());
      ...
      var url = "<?php echo base_url(); ?>markas/core1/fillbill/"+td1+td2;
      var tglctk = new Date();
    ...
    table = $('#tfillgrid').DataTable({
      ...
      "responsive": true,
        ...
        },
        {
            ...
            filename: 'Bil_' + t1 + '_' + t2,
            sheetName: 'Bil_' + t1 + '_' + t2,
        ...
        "titleAttr": 'Export: PDF',
          ...
          "customize": function ( doc ) {
                  ...
                  if( i < doc.content[1].table.body.length-1){
                    if(i < 1){
                      ...
                      bod.push([
                        ...
                        {text:line[9].text, style:'defaultStyle2'}
                      ]);
                    }
                  } else {
                      bod.push([
            ...
            doc.content[1].table.widths = ['4%','5%','9%','7%','16%','15%','16%','9%','9%','11%'];
    ...
    catat("Saring Billing range: " + td1 + " to " + td2);
    reload_table();
}

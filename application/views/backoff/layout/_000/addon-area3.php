...
//    $("#pilprop > option").remove();
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url().'markas/prosespx/get_poli/';?>"+pilpoli,
  ...
  $('#pilkec').change(function(){
    ...
    function editDomain(id){
        ...
        $.ajax({
        type: "POST",
            url:"<?php echo site_url('markas/prosespx/editDomain');?>/"+id2,
            success:function(ed1)
            {
            $('#domain'+id2).html(ed1);
            $('.xc').hide();
            }
    ...
    function fillrajal(jenpx){
      $.blockUI();
      var url = "<?php echo base_url().'markas/prosespx/hisrawat/'.$_GET["name"];?>"+jenpx;
      var tglctk = new Date();
          ...
          "responsive": true,
            ...
            "titleAttr": 'Export: PDF',
              ...
              "customize": function ( doc ) {
                ...
                doc.content[1].table.widths = ['5%','15%','8%','15%','14%','14%'];

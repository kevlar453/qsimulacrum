...
function switchToAll() {
  ...
  $(".menu").removeClass("menu_activated");
  $(".tabdasar").removeClass("is-hidden");
}

function goGallery() {
  removeActive();
  hideAll();
  $("#goGallery").addClass("is-active");
  $("#goGallery-content").removeClass("is-hidden");
  $(".menu").removeClass("menu_activated");
  $(".tabdasar").removeClass("is-hidden");
}
...
function goBook() {
  removeActive();
  hideAll();
  $("#goBook").addClass("is-active");
  $("#goBook-content").removeClass("is-hidden");
  $(".menu").removeClass("menu_activated");
  $(".tabdasar").removeClass("is-hidden");
}
...
function goMaps() {
  removeActive();
  hideAll();
  $("#goMaps").addClass("is-active");
  $("#goMaps-content").removeClass("is-hidden");
  $(".menu").removeClass("menu_activated");
  $(".tablok").removeClass("is-hidden");
}

function goList() {
  hideAll();
  $("#goList-content").removeClass("is-hidden");
  $(".tabdasar").removeClass("is-hidden");
}

function goNews() {
  hideAll();
  $("#goNews-content").removeClass("is-hidden");
  $(".tabdasar").removeClass("is-hidden");
}
...
function hideAll() {
  ...
  $("#goGallery-content").addClass("is-hidden");
  $("#goBook-content").addClass("is-hidden");
  $("#goList-content").addClass("is-hidden");
  $("#goNews-content").addClass("is-hidden");
  $("#goMaps-content").addClass("is-hidden");
  $(".tablok").addClass("is-hidden");
  $(".tabdasar").addClass("is-hidden");
}
